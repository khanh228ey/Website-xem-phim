...
<div class="row container" id="wrapper">
    <div class="halim-panel-filter">
       <div class="panel-heading">
          <div class="row">
             <div class="col-xs-6">
                <div class="yoast_breadcrumb hidden-xs"><span><span><a href="">Thể loại</a> » <span class="breadcrumb_last" aria-current="page">{{$genreSlug->title}}</span></span></span></div>
             </div>
          </div>
       </div>
    ...
    <main id="main-contents" class="col-xs-12 col-sm-12 col-md-8">
       <section>
          <div class="section-bar clearfix">
             <h1 class="section-title"><span>{{$genreSlug->description}}</span></h1>
          </div>
          <div class="halim_box">
            @foreach ($movie as $mv)
